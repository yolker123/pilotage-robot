...
class lecroy():
    ...
    def measurement_setup(self, meas_dict,numberOfAnalogChannels):
        ...
        self.scope.write('VBS app.Measure.ClearAll')
    ...
    def saveWaveform(self, dirPath = "D:", channel="C1", fileName="test"):
        ...
        self.scope.write('VBS app.SaveRecall.Waveform.SaveTo = "File"')
    ...
    def transferFile(self, filefrom, fileto):
        '''
        Transfer a file from the oscilloscope to the pc
        param: filefrom : emplacement du fichier à transferer
        param: fileto: emplacement sur le pc du fichier
        '''
        try:
            self.dso.TransferFileToPc("HDD", filefrom, fileto)
            print("transfert terminer")
        except Exception as e:
            print("Error transferFile : {}".format(e))